...
static const char *fonts[] = {
    "Hack Nerd Font:size=11:antialias=true:",
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask,
     XK_w,
     spawn,
     {.v = (const char *[]){BROWSER_SECONDARY, NULL}}},
    {MODKEY, XK_e, spawn,
    ...
    {MODKEY,
     XK_r,
     spawn,
     {.v = (const char *[]){TERMINAL, "-e", "yazi", NULL}}},
    {MODKEY | ShiftMask,
     XK_r,
     spawn,
    ...
    {MODKEY,
     XK_p,
     spawn,
     {.v = (const char *[]){"passmenu", "-fn", dmenufont, "-nb", normbgcolor,
    ...
    {0, XF86XK_MonBrightnessUp, spawn,
     SHCMD("brightness -A 10")}, /* Permission in sudoers file */
