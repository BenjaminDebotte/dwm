...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_w,		spawn,		{.v = (const char*[]){ BROWSER_SECONDARY, NULL } } },
	...
	{ MODKEY,			XK_p,			spawn,		{.v = (const char*[]){ "passmenu", "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL }}},
	...
	{ MODKEY,			XK_F2,		spawn,		SHCMD("kbreset") }, // Reset keyboard
	...
	{ MODKEY|ControlMask,		XK_w,		spawn,		SHCMD("surf-open") },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("brightness -A 10") }, /* Permission in sudoers file */
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("brightness -U 10") },
